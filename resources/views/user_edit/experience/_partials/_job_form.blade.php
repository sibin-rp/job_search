<div class="row">
  <div class="col-xs-12 col-sm-6">
    <div class="form-group">
      ...
      <select name="experience[internship_field_id]" id="" class="form-control" required="required">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="experience[company_name]"
             value="{{$experience->company_name}}" placeholder="Company Name" required="required">
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-6">
          <div class="form-group">
            <input type="text" placeholder="Started at" class="form-control common-date-picker"
                   name="experience[work_from]" value="{{$experience->work_from}}" required="required"></div>
        </div>
        <div class="col-xs-12 col-sm-6">
          <div class="form-group">
            <input type="text" placeholder="Finished at" class="form-control common-date-picker"
                   name="experience[work_to]" value="{{$experience->work_to}}" required="required"></div>
        </div>
      </div>
    </div>
    <div class="form-group">
  ...
  <div class="col-xs-12">
    <div class="form-group">
      ...
      <textarea name="experience[job_description]" id="" cols="30" rows="5"
                class="form-control" placeholder="Job description" required="required">{{$experience->job_description}}</textarea>
    </div>
  </div>
</div>
